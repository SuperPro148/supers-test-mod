...
public class SupersTestMod implements ModInitializer {
    ...
    public static final Item CHEESE_MAKER = new CheeseMaker(new FabricItemSettings().group(ItemGroup.TOOLS));
    public static final Item CHEESE = new Item(new FabricItemSettings().group(ItemGroup.FOOD));
